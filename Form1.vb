...
Public Class Form1
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        If SQLcon.State = ConnectionState.Open Then
            ...
            ElseIf ComboBox2.Text.Trim() = "" Then
                MessageBox.Show("Entrez Une Ligne")
            ...
            Else
                ...
                Dim cmd As New MySqlCommand("INSERT INTO `suivi_resine_MC204` (Date, DateExpiration, Batch, Ligne, NbWafer, Visa, Commentaire) VALUES(@Date,@DateExpiration,@Batch,@Ligne,@NbWafer,@Visa,@Commentaire)", SQLcon)
                ...
                cmd.Parameters.AddWithValue("@Ligne", ComboBox2.Text)
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        If SQLcon.State = ConnectionState.Open Then
            ...
            Dim cmd As New MySqlCommand("SELECT * FROM `suivi_resine_MC204`", SQLcon)
            Using L As MySqlDataReader = cmd.ExecuteReader()
                ...
                While L.Read()
                    ...
                    Dim ligne As String = L("Ligne")
                    Dim nbwafer As String = L("NbWafer")
                    Dim visa As String = L("Visa")
                    Dim commentaire As String = L("Commentaire")


                    ListView1.Items.Add(New ListViewItem(New String() {dates, datesexpiration, batch, ligne, nbwafer, visa, commentaire}))
                End While
    ...
    Private Sub Button13_Click(sender As Object, e As EventArgs) Handles Button13.Click
        ...
        If SQLcon.State = ConnectionState.Open Then
            ...
            Dim cmd As New MySqlCommand("SELECT * FROM `suivi_resine_MC204`where`Date` between' " + DateTimePicker4.Value.ToString("yyyy-MM-dd 00:00:00") + "' AND '" + DateTimePicker3.Value.ToString("yyyy-MM-dd 23:59:59") + "'", SQLcon)
